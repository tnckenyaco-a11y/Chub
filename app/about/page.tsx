  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-20 lg:px-10">
      <section>
        ...
        <h1 className="font-display mt-4 text-5xl uppercase text-ink sm:text-6xl">
          {story.title}
        </h1>
        <p className="mt-6 max-w-2xl text-ink/70">{story.body}</p>
      </section>
      ...
      <section className="mt-20 border-t border-line pt-16">
        ...
        <h2 className="font-display mt-4 text-4xl uppercase text-ink">{mission.title}</h2>
        <p className="mt-6 max-w-2xl text-ink/70">{mission.body}</p>
      </section>

      <section className="mt-20 border-t border-line pt-16">
        <h2 className="font-display text-4xl uppercase text-ink">{problem.title}</h2>
        <p className="mt-4 max-w-2xl text-ink/70">{problem.intro}</p>
        ...
        <p className="mt-6 max-w-2xl text-ink/70">{problem.resolution}</p>
      </section>

      <section className="mt-20 border-t border-line pt-16">
        <h2 className="font-display text-4xl uppercase text-ink">Our Core Commitments</h2>
        <div className="mt-8 grid gap-8 sm:grid-cols-3">
          {commitments.map((c) => (
            <div key={c.title}>
              <h3 className="font-semibold uppercase tracking-wide text-ink">{c.title}</h3>
      ...
      <section className="mt-20 border-t border-line pt-16 pb-4">
        <h2 className="font-display text-4xl uppercase text-ink">Our Leaders</h2>
        <div className="mt-8 grid gap-8 sm:grid-cols-3">
          {team.map((member) => (
            <div key={member.name}>
